...
#define AUTH "udYvCtHKdYOJSoDnRmf06nF1R9KNKugm"                 // You should get Auth Token in the Blynk App.  
#define WIFI_SSID "ONEPLUS7T"             //Enter Wifi Name
#define WIFI_PASS "77vsk7tarun77"         //Enter wifi Password
...
int ledPin = 2; // choose pin for the LED
